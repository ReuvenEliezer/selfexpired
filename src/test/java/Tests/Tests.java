...
public class Tests {
    ...
    @Test
    public void changeSamplingRate() {
        LocalDateTime now = LocalDateTime.now();
        ConditionValue  conditionValue = new ConditionValue(1, 2d,now, now.plusMinutes(10));
    ...
    class ConditionValue {
        ...
        public ConditionValue(Integer deviceId, Double value, LocalDateTime startDateTime, LocalDateTime endDateTime) {
            this.deviceId = deviceId;
            this.value = value;
